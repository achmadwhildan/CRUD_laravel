            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('datas.index') }}">Data</a></li>
                        <li><a class="dropdown-item" href="{{ route('datas.create') }}">Tambah Data</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('values.index') }}">Nilai</a></li>
                        <li><a class="dropdown-item" href="{{ route('values.create') }}">Tambah Nilai</a></li>
                    </ul>
                </li>
            </ul>
